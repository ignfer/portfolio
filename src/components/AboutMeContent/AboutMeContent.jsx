    ...
    <>
      <section className='about-me-content'>
        <div className={tabIndex === 1 ? 'active-tab' : 'tab'}>
          <p>
            Hello! I am Ignacio, a <strong>22 years old software developer residing in Uruguay. </strong>
            For over <strong>7 years,</strong> I have been building expertise in the field 
            of <strong>computer science</strong>. Currently I am pursuing the last year 
